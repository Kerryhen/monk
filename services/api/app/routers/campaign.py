...
def create_campaign(body: LM_CreateCampaignSchema, iface: InterfaceAPI, _: MonkAuth, x_instance_id: InstanceID):
...
def get_campaigns(iface: InterfaceAPI, _: MonkAuth, x_instance_id: InstanceID):
...
def delete_campaign(campaign_id: int, iface: InterfaceAPI, _: MonkAuth, x_instance_id: InstanceID):
...
def start_campaign(campaign_id: int, iface: InterfaceAPI, _: MonkAuth, x_instance_id: InstanceID):
...
def stop_campaign(campaign_id: int, iface: InterfaceAPI, _: MonkAuth, x_instance_id: InstanceID):
